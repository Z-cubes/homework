...
MAWS_city = readtable('CEE4211 Homework 2 Data.xlsx', 'Sheet', 'DemandFunctions', 'Range', 'C6:C16');
MV_city = readtable('CEE4211 Homework 2 Data.xlsx', 'Sheet', 'DemandFunctions', 'Range', 'D6:D16');
MAWS_farm = readtable('CEE4211 Homework 2 Data.xlsx', 'Sheet', 'DemandFunctions', 'Range', 'L4:L16');
MV_farm = readtable('CEE4211 Homework 2 Data.xlsx', 'Sheet', 'DemandFunctions', 'Range', 'M4:M16');

% Convert tables to arrays for easier calculations
Years = table2array(Years);
I1 = table2array(I1);

MAWS_city = table2array(MAWS_city);
MV_city = table2array(MV_city);
MAWS_farm = table2array(MAWS_farm);
MV_farm = table2array(MV_farm);
